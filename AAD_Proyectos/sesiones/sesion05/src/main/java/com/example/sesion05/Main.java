...
import com.example.sesion05.model.Empleado;
import com.example.sesion05.model.Habitacion;

public class Main {
    public static void main(String[] args) {
        // INSERT INTO empleados (nombre, apellido, correo, salario) VALUES ("", "", "", 0000)
        Empleado empleado = new Empleado ("Guillem", "Colombi", "guille@gmail.com", 2000000, "PROProgrammer");
